...
def newsnr_sgveto_psdvar(snr, bchisq, sgchisq, psd_var_val):
    ...
    t = numpy.array(psd_var_val >= 1.15, ndmin=1)
    if len(t) > 0:
...
def newsnr_sgveto_psdvar_scaled(snr,bchisq,sgchisq,psd_var_val):
    ...
    scaled_snr = snr/numpy.sqrt(psd_var_val)
...
__all__ = ['threshold_and_cluster', 'newsnr', 'effsnr', 'newsnr_sgveto',
           'newsnr_sgveto_psdvar', 'newsnr_sgveto_psdvar_scaled' ,'findchirp_cluster_over_window',
